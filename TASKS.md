...
2 | 2-2 | Permettre l'upload de fichier audio sur le server | 980 | |
2 | 2-3 | Effectuer une vérification des fichiers (sécurité) | 970 | |
2 | 2-4 | Permettre au flux audio de lire tous les morceaux uploadés (liste de lecture dynamique) | 960 | |
3 | 3-1 | Créer les schémas de données 'User' et 'Team' | 890 | |
3 | 3-2 | Attacher automatiquement les Tracks à une Team lors de leur upload | 880 | |
